...
return [
    ...
    'auth' => [
        'use_login' => true,
        'class' => App\PageBuilder\Modules\Auth\Auth::class,
        // 'class' => PHPageBuilder\Modules\Auth\Auth::class,
        'url' => '/pagebuilder/auth',
        // 'url' => '/login',
        'username' => 'tronicspay@gmail.com',
        'password' => 'tronicspay'
    ],
    ...
    'website_manager' => [
        ...
        // 'class' => App\Http\Controllers\Admin\PageBuilderController::class,
        'class' => App\PageBuilder\Modules\WebsiteManager\WebsiteManager::class,
     ...
     */
    'class_replacements' => [
        PHPageBuilder\Modules\Auth\Auth::class => App\PageBuilder\Modules\Auth\Auth::class, 
        // PHPageBuilder\Modules\WebsiteManager\WebsiteManager::class => App\PageBuilder\Modules\WebsiteManager\WebsiteManager::class,
    ],
];
