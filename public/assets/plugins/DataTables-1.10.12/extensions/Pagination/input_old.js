...
$.fn.dataTableExt.oPagination.input = {
    "fnInit": function ( oSettings, nPaging, fnCallbackDraw )
    {
        ...
        nFirst.className = "paginate_button first disabled btn btn-primary btn-sm btn-flat";
        nPrevious.className = "paginate_button previous disabled  btn btn-primary btn-sm btn-flat";
        nNext.className="paginate_button next  btn btn-primary btn-sm btn-flat";
        nLast.className = "paginate_button last  btn btn-primary btn-sm btn-flat";
        nOf.className = "paginate_of";
        nPage.className = "paginate_page";
        nInput.className = "paginate_input form-control input-sm";
        nInput.setAttribute( 'size','5');
        if ( oSettings.sTableId !== '' )
        {
            nPaging.className = nPaging.className + " input-pagination";
