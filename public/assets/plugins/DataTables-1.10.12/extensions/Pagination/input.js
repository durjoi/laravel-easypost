...
(function ($) {
	...
	var firstClassName = 'first btn btn-primary btn-sm btn-flat';
	var previousClassName = 'previous btn btn-primary btn-sm btn-flat';
	var nextClassName = 'next btn btn-primary btn-sm btn-flat';
	var lastClassName = 'last btn btn-primary btn-sm btn-flat';
