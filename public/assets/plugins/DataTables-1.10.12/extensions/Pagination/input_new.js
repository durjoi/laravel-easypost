...
(function ($) {
	...
	var btnClass = 'btn btn-primary btn-sm btn-flat';
	...
	$.fn.dataTableExt.oPagination.input = {
		'fnInit': function (oSettings, nPaging, fnCallbackDraw) {
			...
			nFirst.className = firstClassName + ' ' + classes.sPageButton + ' ' + btnClass;
			nPrevious.className = previousClassName + ' ' + classes.sPageButton + ' ' + btnClass;
			nNext.className = nextClassName + ' ' + classes.sPageButton + ' ' + btnClass;
			nLast.className = lastClassName + ' ' + classes.sPageButton + ' ' + btnClass;

			nOf.className = paginateOfClassName;
			nPage.className = paginatePageClassName;
			nInput.className = paginateInputClassName + ' ' + inputClass;
