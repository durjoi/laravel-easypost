...
// function initiatePageEditor(CSRF_TOKEN, reloadPageApi, pageBuilderSave) 
// {
//     var lp = './img/';
...
//     // document.querySelector('.gjs-logo-version').innerHTML = 'v0.16.41';
...
function initiatePageEditor(CSRF_TOKEN, reloadPageApi, pageBuilderSave) 
{
    ...
    var lp = '../../../../plugins/pagebuilder/images/';
    var plp = '//placehold.it/350x250/';
    var images = [
        lp+'team1.jpg', lp+'team2.jpg', lp+'team3.jpg', plp+'78c5d6/fff/image1.jpg', plp+'459ba8/fff/image2.jpg', plp+'79c267/fff/image3.jpg',
        plp+'c5d647/fff/image4.jpg', plp+'f28c33/fff/image5.jpg', plp+'e868a2/fff/image6.jpg', plp+'cc4360/fff/image7.jpg',
    ...
    var editor  = grapesjs.init({
        ...
        storageManager: {
            type: 'remote',
            stepsBeforeSave: 1,
            urlStore: reloadPageApi,
            urlLoad: reloadPageApi,
