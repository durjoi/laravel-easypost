...
<html lang="en">
    <head>
        ...
        <script src="{{ url('library/js/admin/pagebuilder/page-builder-editor.js') }}"></script>
    ...
    <body data-url="{{ url('/') }}">
        ...
        <script type="text/javascript">
            var pageBuilderSave = "{{ url('admin/pagebuilder') }}/"+{{ $page_id }}+"/build";
            initiatePageEditor('{{ csrf_token() }}', '{{ $reload_page_api }}', pageBuilderSave);
        </script>
    </body>
</html>
