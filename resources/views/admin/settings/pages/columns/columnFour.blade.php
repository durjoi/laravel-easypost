...
<div class="col-lg-3">
            ...
            @if($content->content_type == 'paragraph')
              <div class="tronics">
                <div class="tronics-wrap">
                  {!! $result->content !!}
                  <div class="tronics-links">
                    <a href="javascript:void(0)" onclick="editContent(<?php echo $column->id; ?>,<?php echo $content->id; ?>, 3, 'paragraph')" class="btn btn-success btn-sm"><i class="far fa-edit fa-fw"></i> Edit</a>
                  </div>
                </div>
              </div>
            @endif
            @if($content->content_type == 'header')
              <div class="tronics">
                <div class="tronics-wrap">
                  <h2>{{ $result->header }}</h2>
                  <div class="tronics-links">
                    <a href="javascript:void(0)" onclick="editContent(<?php echo $column->id; ?>,<?php echo $content->id; ?>, 3, 'header')" class="btn btn-success btn-sm"><i class="far fa-edit fa-fw"></i> Edit</a>
                  </div>
                </div>
              </div>
            @endif
            @if($content->content_type == 'image')
              <div class="tronics">
                <div class="tronics-wrap">
                  ...
                  <div class="tronics-links">
                    <a href="javascript:void(0)" onclick="editContent(<?php echo $column->id; ?>,<?php echo $content->id; ?>, 3, 'image')" class="btn btn-success btn-sm"><i class="far fa-edit fa-fw"></i> Edit</a>
                  </div>
                </div>
              </div>
            @endif
            @if($content->content_type == 'video')
              <div class="tronics">
                <div class="tronics-wrap">
                  ...
                  <div class="tronics-links">
                    <a href="javascript:void(0)" onclick="editContent(<?php echo $column->id; ?>,<?php echo $content->id; ?>, 3, 'video')" class="btn btn-success btn-sm"><i class="far fa-edit fa-fw"></i> Edit</a>
                  </div>
                </div>
              </div>
            @endif
            @if($content->content_type == 'link')
              <div class="tronics">
                <div class="tronics-wrap">
                  <a href="{{ $result->link_url }}" class="btn btn-warning btn-md" target="{{ $result->link_target }}">{{ $result->link_value }}</a>
                  <div class="tronics-links">
                    <a href="javascript:void(0)" onclick="editContent(<?php echo $column->id; ?>,<?php echo $content->id; ?>, 3, 'link')" class="btn btn-success btn-sm"><i class="far fa-edit fa-fw"></i> Edit</a>
                  </div>
                </div>
              </div>
            @endif
  ...
  @endif
  <div class="text-center card-footer clearfix">
    <a href="javascript:void(0);" class="btn btn-sm btn-primary" onclick="addcontent(<?php echo $row->column[2]['id']; ?>, 3)">Add Content</a>
  </div>
</div>
<div class="col-lg-3">
  @if(!empty($row->column))
            ...
            @if($content->content_type == 'paragraph')
              <div class="tronics">
                <div class="tronics-wrap">
                  {!! $result->content !!}
                  <div class="tronics-links">
                    <a href="javascript:void(0)" onclick="editContent(<?php echo $column->id; ?>,<?php echo $content->id; ?>, 4, 'paragraph')" class="btn btn-success btn-sm"><i class="far fa-edit fa-fw"></i> Edit</a>
                  </div>
                </div>
              </div>
            @endif
            @if($content->content_type == 'header')
              <div class="tronics">
                <div class="tronics-wrap">
                  <h2>{{ $result->header }}</h2>
                  <div class="tronics-links">
                    <a href="javascript:void(0)" onclick="editContent(<?php echo $column->id; ?>,<?php echo $content->id; ?>, 4, 'header')" class="btn btn-success btn-sm"><i class="far fa-edit fa-fw"></i> Edit</a>
                  </div>
                </div>
              </div>
            @endif
            @if($content->content_type == 'image')
              <div class="tronics">
                <div class="tronics-wrap">
                  ...
                  <div class="tronics-links">
                    <a href="javascript:void(0)" onclick="editContent(<?php echo $column->id; ?>,<?php echo $content->id; ?>, 4, 'image')" class="btn btn-success btn-sm"><i class="far fa-edit fa-fw"></i> Edit</a>
                  </div>
                </div>
              </div>
            @endif
            @if($content->content_type == 'video')
              <div class="tronics">
                <div class="tronics-wrap">
                  ...
                  <div class="tronics-links">
                    <a href="javascript:void(0)" onclick="editContent(<?php echo $column->id; ?>,<?php echo $content->id; ?>, 4, 'video')" class="btn btn-success btn-sm"><i class="far fa-edit fa-fw"></i> Edit</a>
                  </div>
                </div>
              </div>
            @endif
            @if($content->content_type == 'link')
              <div class="tronics">
                <div class="tronics-wrap">
                  <a href="{{ $result->link_url }}" class="btn btn-warning btn-md" target="{{ $result->link_target }}">{{ $result->link_value }}</a>
                  <div class="tronics-links">
                    <a href="javascript:void(0)" onclick="editContent(<?php echo $column->id; ?>,<?php echo $content->id; ?>, 4, 'link')" class="btn btn-success btn-sm"><i class="far fa-edit fa-fw"></i> Edit</a>
                  </div>
                </div>
              </div>
            @endif
  ...
  @endif
  <div class="text-center card-footer clearfix">
    <a href="javascript:void(0);" class="btn btn-sm btn-primary" onclick="addcontent(<?php echo $row->column[3]['id']; ?>, 4)">Add Content</a>
  </div>
</div>