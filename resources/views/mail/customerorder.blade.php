                        ...
                        <div style="border: 1px solid #777; background: #fff; padding: 15px;">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12" style="font-size: 20px;">
                                    <p>
                                        Hi {{ $customer_transaction['customer']['fullname'] }}, 
                                    </p>
                                    <p>
                                        {!! $customer_transaction['status']['template'] !!}
                                    </p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 form-group" align="center">
                                    <a href="{{ url('/customer/my-bundles/'.$customer_transaction['hashedid'].'?email=true') }}" class="btn btn-primary btn-flat">
                                        View Order
                                    </a>
                                </div>
                            </div>
