        ...
        $(document).ready(function () {
            ...
            $(".btn-carrier").on("click",function(e){
                ...
                specs[network_id].map(spec => {
                    let size_button = `<label class="btn btn-outline-warning radio-btn" style="margin-right: 4px;">
            ...
            function showDescription(){
                if(condition){
                    ...
                    switch(condition){
                        ...
                        case 'good_offer': items = ['Fully functional','No major scratches, scuffs or nicks','No cracks or broken hardware','Phone has a good ESN / IMEI']; break;
                        case 'fair_offer': items = ['Cracked back','Defective buttons','Significant wear and tear','Housing Damage']; break;  
                        case 'poor_offer': items = ['Does NOT power on','Damaged LCD','Missing parts or bent frame','Any Password lock',]; break;
                    }
