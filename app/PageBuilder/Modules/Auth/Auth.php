...
namespace App\PageBuilder\Modules\Auth;

// use PHPageBuilder\Contracts\AuthContract;

class Auth implements \PHPageBuilder\Contracts\AuthContract
{
    /**
    ...
    {
        // echo phpb_url('website_manager');
        // echo 'qwe';exit;
        return redirect()->to(phpb_url('website_manager'));
