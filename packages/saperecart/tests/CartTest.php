...
namespace Saperemarketing\Tests\SCart;

use Mockery;
use PHPUnit\Framework\Assert;
use Saperemarketing\SCart\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use Saperemarketing\SCart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use Saperemarketing\SCart\SCartServiceProvider;
use Saperemarketing\Tests\SCart\Fixtures\ProductModel;
use Saperemarketing\Tests\SCart\Fixtures\BuyableProduct;
use Saperemarketing\Tests\SCart\CartAssertions;
...
class CartTest extends TestCase
{
    ...
    {
        return [SCartServiceProvider::class];
    }
    ...
    /**
     * @test
     * @expectedException \Saperemarketing\SCart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \Saperemarketing\SCart\Exceptions\UnknownModelException
    ...
    public function it_can_store_the_cart_in_a_database()
    {
        ...
        $this->assertDatabaseHas('SCart', ['identifier' => $identifier, 'instance' => 'default', 'content' => $serialized]);
    ...
    /**
     * @test
     * @expectedException \Saperemarketing\SCart\Exceptions\CartAlreadyStoredException
    ...
    public function it_can_restore_a_cart_from_the_database()
    {
        ...
        $this->assertDatabaseMissing('SCart', ['identifier' => $identifier, 'instance' => 'default']);
     ...
     *
     * @return \Saperemarketing\SCart\Cart
     */
